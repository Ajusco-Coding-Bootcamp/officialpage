...
const Root = styled('div')(({ theme }) => ({
    ...
    const reactHardSkills = ["JavaScript up to ES6", "Hooks", "OOP", "Components Architecture", "Node", "NPM", "React JS", "Git", "GitHub, Pages", "CI/CD", "Responsive Design", "User Centricity", "Bootstrap/ Materialize", "Material UI", "Jest", "Router", "Firebase Auth services", "Firestore", "Data Modeling: JSON", "API Consumption", "Agile Methodology", "SDLC - Agile", "Documentation", "MarkDown", "HTML5", "CSS3", "Marvel App", "Programming Logic"]


    const requeriments = ["No es necesario tener conocimientos previos","Nivel mínimo de inglés: Básico", "Intensive 6 months Plan : 8h diarias", "Total Expertisse: 1400 hrs"]
...
const ReactJS = () => {
      ...
      return (
            <div>
                  <h2>React JS Software Development</h2>
                  <Root>
                  <Divider></Divider>
                        <div>
    ...
    <Skills skills= {reactHardSkills}/>
    <Divider textAlign="center">
      <Chip label=" Projects " />
    </Divider>
      <div>
            Programa totalmente orientado a la resolución de problemas reales mediante la elaboración de 12 proyectos y 1 práctica profesional.
      </div>
      <Divider textAlign="center">
